			...
			<div class="row">
				<div class="col-md-12">
					<div class="mt-5 mb-3 clearfix">
						<h2 class="text-start"><strong>ගාල්ල - ප්‍රජාවගේ ධාරිතාව වර්ධනය කිරීම</strong></h2>
						<br>
						<a href="gp_add.php" class="btn btn-success pull-right"><btn><i class="fa fa-plus-circle fa-lg"></i> Add a New Row </btn></a>	
						...
						<caption>
							...
							<p class="text-start"><strong>අංශය - </strong>ප්‍රජාවගේ ධාරිතාව වර්ධනය කිරීම</P>
									...
									echo "<tbody>";
    									while($row=mysqli_fetch_array($result)) 
										{
											echo "<tr>";
                								...
                								echo "<td>";
													echo '<a href="gp_read.php?id='.$row['id'].'" class="read"><i class="fas fa-eye fa-2x center"></i></a>';
													echo "<br>";
													echo '<a href="gp_edit.php?id='.$row['id'].'" class="edit"><i class="fas fa-pen fa-2x center"></i></a>';
                    								echo "<br>";
													echo "<a onclick='javascript:confirmationDelete($(this));return false;' href='gp_del.php?id=".$row['id']."'><i class='fas fa-trash fa-2x center'></i></a>";
													echo "<br>";
												echo "</td>";
											echo "</tr>";
										}
