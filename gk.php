...
?>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="mt-5 mb-3 clearfix">
								...
								<br>
								<a href="gk_add.php" class="btn btn-success pull-right">
									<btn><i class="fa fa-plus-circle fa-lg"></i> Add a New Row </btn>
								</a>
								<a href="create.php" class="btn btn btn-primary pull-right"><i
								...
								<a href="#" onclick="delete_selected()"
									class="btn btn btn-danger pull-right delete_all"><i
										class="fas fa-minus-circle fa-lg"></i> Delete </a>

								<div class="wrap">
									<div class="search">
										<form method="POST" action="gk.php">
											<div class="btn-group">
												<input type="text" style="width:350px" name="search_txt"
													class="searchTerm" placeholder="ව්‍යාපෘති අංකය/ ව්‍යාපෘතිය">
												<button type="submit" name="search_btn" class="searchButton">
						...
						if(!isset($_POST['search_btn'])){
							...
							if(trim($search_txt)==""){
								...
								$sql = "SELECT * FROM gallek WHERE gk_a='$search_txt' OR gk_c='$search_txt'";
							}							
						}
									...
									echo "<tbody>";
    									while($row=mysqli_fetch_array($result)) 
										{
											echo "<tr>";
												...
												echo"<td>";
													echo '<input type="checkbox" id="delete_chk" onclick="delete_check('.$row['id'].',this)" >';
												echo "</td>";
                								...
                								echo "<td>";
													echo '<a href="gk_read.php?id='.$row['id'].'" class="read"><i class="fas fa-eye fa-2x center"></i></a>';
													echo "<br>";
													echo '<a href="gk_edit.php?id='.$row['id'].'" class="edit"><i class="fas fa-pen fa-2x center"></i></a>';
                    								echo "<br>";
													echo "<a onclick='javascript:confirmationDelete($(this));return false;' href='gk_del.php?id=".$row['id']."'><i class='fas fa-trash fa-2x center'></i></a>";
													echo "<br>";
												echo "</td>";
											echo "</tr>";
										}
	...
	<script>
		var itemsToDel = []; //store items to delete from table

		function delete_check(id, _element) {

			if (_element.checked) { //determine checkbox checked status.
				itemsToDel.push(id); // if checkbox checked, row_id added into array.
			} else { /// if checkbox un-checked, row_id remove from array.
				var index = itemsToDel.indexOf(id);
	...
	<script>
			...
			const swalWithBootstrapButtons = Swal.mixin({
				...
				reverseButtons: true
					...
					if (result.value===true) {
						...
						//Send Delete Request
				var xmlhttp_sname = new XMLHttpRequest();
				xmlhttp_sname.onreadystatechange = function () {
        ...
        xmlhttp_sname.open("GET", "gk_delete.php?ids=" + itemsToDel, true);
        xmlhttp_sname.send();
