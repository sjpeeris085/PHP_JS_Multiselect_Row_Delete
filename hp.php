			...
			<div class="row">
				<div class="col-md-12">
					<div class="mt-5 mb-3 clearfix">
						<h2 class="text-start"><strong>හම්බන්තොට - ප්‍රජාවගේ ධාරිතාව වර්ධනය කිරීම</strong></h2>
						<br>
						...
						<caption>
							...
							<p class="text-start"><strong>දිස්ත්‍රික්කය - </strong>හම්බන්තොට</P>
						</caption>
									...
									echo "<tbody>";
    									while($row=mysqli_fetch_array($result)) 
										{
											echo "<tr>";
                								...
                								echo "<td>";
													echo '<a href="hp_read.php?id='.$row['id'].'" class="read"><i class="fas fa-eye fa-2x center"></i></a>';
													echo "<br>";
													echo '<a href="hp_edit.php?id='.$row['id'].'" class="edit"><i class="fas fa-pen fa-2x center"></i></a>';
                    								echo "<br>";
													echo "<a onclick='javascript:confirmationDelete($(this));return false;' href='hp_del.php?id=".$row['id']."'><i class='fas fa-trash fa-2x center'></i></a>";
													echo "<br>";
												echo "</td>";
											echo "</tr>";
										}
